	...
	mProgramChangeCallback(progChangeCallback)
{
	...
	mBuilder([this](ossia::net::node_base * root) {
			...
			{
				auto n = conf->create_child("control_midi_in");
...

			{
				...
				auto n = conf->create_child("control_auto_connect_midi");
				n->set(ossia::net::description_attribute{}, "auto connect MIDI to use for control (patcher selection)");
