set(CONAN_PROFILE "aarch64-unknown-linux-gcc12" CACHE STRING "the conan profile to use")
...
set(ENV{AR} ${tools}/aarch64-linux-gnu-gcc-ar-12)
set(ENV{RANLIB} ${tools}/aarch64-linux-gnu-gcc-ranlib-12)
set(ENV{LD} ${tools}/aarch64-linux-gnu-ld)
set(ENV{STRIP} ${tools}/aarch64-linux-gnu-strip)
set(ENV{CC} ${tools}/aarch64-linux-gnu-gcc-12)
set(ENV{CXX} ${tools}/aarch64-linux-gnu-g++-12)
set(ENV{PKG_CONFIG_SYSROOT_DIR} ${SYSROOT})
set(ENV{PKG_CONFIG_LIBDIR} "/usr/lib/aarch64-linux-gnu/pkgconfig:/usr/share/pkgconfig")

set(CMAKE_C_COMPILER ${tools}/aarch64-linux-gnu-gcc-12)
set(CMAKE_CXX_COMPILER ${tools}/aarch64-linux-gnu-g++-12)
set(CMAKE_AR ${tools}/aarch64-linux-gnu-gcc-ar-12)
set(CMAKE_RANLIB ${tools}/aarch64-linux-gnu-gcc-ranlib-12)
