set(CONAN_PROFILE "armv7-unknown-linux-gnueabihf-gcc12" CACHE STRING "the conan profile to use")
...
set(ENV{AR} ${tools}/arm-linux-gnueabihf-gcc-ar-12)
set(ENV{RANLIB} ${tools}/arm-linux-gnueabihf-gcc-ranlib-12)
set(ENV{LD} ${tools}/arm-linux-gnueabihf-ld)
set(ENV{STRIP} ${tools}/arm-linux-gnueabihf-strip)
set(ENV{CC} ${tools}/arm-linux-gnueabihf-gcc-12)
set(ENV{CXX} ${tools}/arm-linux-gnueabihf-g++-12)
set(ENV{PKG_CONFIG_SYSROOT_DIR} ${SYSROOT})
set(ENV{PKG_CONFIG_LIBDIR} "/usr/lib/arm-linux-gnueabihf/pkgconfig:/usr/share/pkgconfig")

set(CMAKE_C_COMPILER ${tools}/arm-linux-gnueabihf-gcc-12)
set(CMAKE_CXX_COMPILER ${tools}/arm-linux-gnueabihf-g++-12)
set(CMAKE_AR ${tools}/arm-linux-gnueabihf-gcc-ar-12)
set(CMAKE_RANLIB ${tools}/arm-linux-gnueabihf-gcc-ranlib-12)
